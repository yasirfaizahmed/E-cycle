...
def get_pulse(number):
    ...
    if rotation >= 2:
		...
		speed_kmph = (1.7280466) / elapse #km/h
...
class dashboardApp(App):
    variables = DictProperty(
        {"speed": speed_kmph, "kms_ran": distance_ran_km, "mileage": 56, "battery_percentage": 49, "btry_crg_sts": False,
...
if __name__ == "__main__":
	...
	gpio.add_event_detect(hallpin,gpio.RISING,callback = get_pulse,bouncetime=20)
